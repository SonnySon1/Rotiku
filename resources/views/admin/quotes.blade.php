                            ...
                            <table class="table table-hover my-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-xl-table-cell">Qoutes</th>
                                        <th class="d-none d-xl-table-cell">Text By</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            {{-- {{ $d->quotes }} --}}
                                            <td class="d-none d-xl-table-cell">Quotes</td>

                                            {{-- {{ $d->text_by }} --}}
                                            <td class="d-none d-xl-table-cell">Text By</td>
