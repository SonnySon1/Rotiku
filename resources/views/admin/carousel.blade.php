    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="row">
                    <div>
                        <a href="{{ route('admin.carousel.create') }}" class="btn btn-primary">Tambah carousel</a>
                            ...
                            <table class="table table-hover my-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell"><a href="{{ route('admin.carousel.edit', $d->id_carousel) }}"
                                        ...
                                        <td class="d-none d-md-table-cell">
                                            <a href="{{ route('admin.carousel.destroy',$d->id_carousel) }}" class="btn btn-danger" id="delete">
                                                <svg
